...
namespace SigaClasses
{
    public class SigaDriver
    {
        private static readonly Dictionary<string, string> Courses = new Dictionary<string, string>
        {
            ...
            { "Ciências Biológicas - Macaé", "2658AB28-92A4-F79C-019D-17982F25B6DD"},
            ...
            { "Ciências Biológicas Biofísica Ênfase: Bioinformática - Polo de Xerém", "9A6B9AC3-92A4-F79C-1B6D-99798A098F87"},
            ...
            { "Educação Física Integral - Fundão", "7C525F7D-92A4-F7A0-66EC-6406F3DA6C5F"},
            { "Educação Física Noturno - Fundão", "026EECB6-92A4-F79C-77D2-1A9BA3202B44"},
            ...
            { "Letras: Português-Literatura Integral - Fundão", "F1CC7D4D-92A4-F79B-0232-AE984EA53CE5"},
            { "Letras: Português-Literatura Noturno - Fundão", "A16E4429-92A4-F79B-5556-D74F742EB37C"},
            ...
            { "Licenciatura em Ciências Sociais Integral- Praia Vermelha", "5B480A69-92A4-F79E-25D2-5F8DAB4BE6E7"},
